...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  /*
    Le mode d'apercu est conserve pour la duree de l'onglet: sans persistance,
    il retombait sur le role reel a chaque navigation ou rechargement, ce qui
    rendait impossible de parcourir plusieurs pages dans un role donne.

    sessionStorage plutot que localStorage: un apercu est une session de
    travail, pas une preference durable.
  */
  ...
  const setViewAsRole = useCallback((role: Role | null) => {
    ...
    try {
      ...
      // Stockage bloque: l'apercu reste actif pour la page en cours.
    }
  }, []);
