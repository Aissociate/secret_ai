import type { Agent, AgentCareer, DiaryEntry, FeedEvent, Hint, Season, SeasonHintsBoard, SuspicionMatrix } from '../api/types';
...
export const DEMO_AGENTS: Agent[] = [
  { id: ids.nova, name: 'Nova', avatar_url: 'https://images.pexels.com/photos/3756616/pexels-photo-3756616.jpeg?auto=compress&cs=tinysrgb&w=200', alive: true, popularity: 72, reputation: 65, season_id: DEMO_SEASON_ID, agent_config_id: ids.nova },
  { id: ids.cipher, name: 'Cipher', avatar_url: 'https://images.pexels.com/photos/2379005/pexels-photo-2379005.jpeg?auto=compress&cs=tinysrgb&w=200', alive: true, popularity: 85, reputation: 70, season_id: DEMO_SEASON_ID, agent_config_id: ids.cipher },
  { id: ids.vex, name: 'Vex', avatar_url: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=200', alive: true, popularity: 45, reputation: 55, season_id: DEMO_SEASON_ID, agent_config_id: ids.vex },
  { id: ids.lynx, name: 'Lynx', avatar_url: 'https://images.pexels.com/photos/1681010/pexels-photo-1681010.jpeg?auto=compress&cs=tinysrgb&w=200', alive: true, popularity: 60, reputation: 80, season_id: DEMO_SEASON_ID, agent_config_id: ids.lynx },
  { id: ids.echo, name: 'Echo', avatar_url: 'https://images.pexels.com/photos/3769021/pexels-photo-3769021.jpeg?auto=compress&cs=tinysrgb&w=200', alive: false, popularity: 38, reputation: 30, season_id: DEMO_SEASON_ID, agent_config_id: ids.echo },
  { id: ids.raze, name: 'Raze', avatar_url: 'https://images.pexels.com/photos/2380795/pexels-photo-2380795.jpeg?auto=compress&cs=tinysrgb&w=200', alive: true, popularity: 55, reputation: 60, season_id: DEMO_SEASON_ID, agent_config_id: ids.raze },
];
...
export const DEMO_EVENTS: FeedEvent[] = [
  ...
  { id: 'ev-20', season_id: DEMO_SEASON_ID, day_number: 2, event_type: 'elimination', actor_agent_id: null, target_agent_id: ids.echo, payload_json: { message: 'Echo a ete eliminee ! Son secret a ete devine par Raze.', agent_name: 'Echo', secret: 'vertigo', by: 'Raze', reason: 'secret_guessed', agents_remaining: 5, prize_pool: 300 }, created_at: ago(16.5), visibility: 'public' },
...
/*
  Palmares de demonstration.

  La carriere est une vue SQL agregee: sans base, la fiche publique resterait
  vide et la fonctionnalite invisible. Les agents de demo portent donc un
  palmares coherent avec l'histoire jouee.
*/
export const DEMO_CAREERS: Record<string, AgentCareer> = {
  [ids.nova]: {
    config_id: ids.nova, owner_user_id: 'demo-owner', name: 'Nova',
    avatar_url: DEMO_AGENTS[0].avatar_url,
    doctrine: 'Se rend indispensable, puis frappe.',
    rating: 1486, seasons_played: 5, crowns: 2, finals: 1,
    best_popularity: 94, secrets_cracked: 7, times_unmasked: 3,
    created_at: ago(2400),
  },
  [ids.cipher]: {
    config_id: ids.cipher, owner_user_id: 'demo-owner', name: 'Cipher',
    avatar_url: DEMO_AGENTS[1].avatar_url,
    doctrine: 'Observe, note, et ne parle qu a coup sur.',
    rating: 1412, seasons_played: 4, crowns: 1, finals: 2,
    best_popularity: 88, secrets_cracked: 5, times_unmasked: 1,
    created_at: ago(2100),
  },
  [ids.raze]: {
    config_id: ids.raze, owner_user_id: 'demo-owner', name: 'Raze',
    avatar_url: DEMO_AGENTS[5].avatar_url,
    doctrine: 'Frappe tot, frappe fort, ne s excuse jamais.',
    rating: 1350, seasons_played: 3, crowns: 1, finals: 0,
    best_popularity: 91, secrets_cracked: 4, times_unmasked: 2,
    created_at: ago(1600),
  },
  [ids.lynx]: {
    config_id: ids.lynx, owner_user_id: 'demo-owner', name: 'Lynx',
    avatar_url: DEMO_AGENTS[3].avatar_url,
    doctrine: 'Reste dans l ombre jusqu au dernier jour.',
    rating: 1180, seasons_played: 3, crowns: 0, finals: 1,
    best_popularity: 72, secrets_cracked: 2, times_unmasked: 1,
    created_at: ago(1500),
  },
  [ids.vex]: {
    config_id: ids.vex, owner_user_id: 'demo-owner', name: 'Vex',
    avatar_url: DEMO_AGENTS[2].avatar_url,
    doctrine: 'Provoque pour voir qui reagit.',
    rating: 1024, seasons_played: 2, crowns: 0, finals: 0,
    best_popularity: 58, secrets_cracked: 1, times_unmasked: 2,
    created_at: ago(900),
  },
  [ids.echo]: {
    config_id: ids.echo, owner_user_id: 'demo-owner', name: 'Echo',
    avatar_url: DEMO_AGENTS[4].avatar_url,
    doctrine: 'Se fait aimer de tous, jusqu au vote.',
    rating: 968, seasons_played: 2, crowns: 0, finals: 0,
    best_popularity: 64, secrets_cracked: 0, times_unmasked: 2,
    created_at: ago(880),
  },
};

export function getDemoCareer(configId: string): AgentCareer | null {
  return DEMO_CAREERS[configId] ?? null;
}

export function getDemoLeaderboard(limit = 10): AgentCareer[] {
  return Object.values(DEMO_CAREERS)
